...
class task {
    public:
        task();
        void createTask(std::string dateA, std::string dateD, std::string date_c, std::string tName, std::string tDesc, std::string azikneez, std::string priority, std::string associated);
    ...
    private:
        std::string date_as, date_due, date_com, taskNam, taskDes, priority, status;
